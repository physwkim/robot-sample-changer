...
```bash
ros2 run xacro xacro $(ros2 pkg prefix ur3e_hande_description)/share/ur3e_hande_description/urdf/ur.urdf.xacro name:=ur ur_type:=ur3e\
joint_limit_params:=$(ros2 pkg prefix ur3e_hande_description)/share/ur3e_hande_description/config/ur3e/joint_limits.yaml\
kinematics_params:=$(ros2 pkg prefix ur3e_hande_description)/share/ur3e_hande_description/config/ur3e/default_kinematics.yaml\
physical_params:=$(ros2 pkg prefix ur3e_hande_description)/share/ur3e_hande_description/config/ur3e/physical_parameters.yaml\
visual_params:=$(ros2 pkg prefix ur3e_hande_description)/share/ur3e_hande_description/config/ur3e/visual_parameters.yaml > ur.urdf
```
